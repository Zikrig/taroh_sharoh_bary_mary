...
SECTION_GUIDANCE = {
    "personality": {
        "Асцендент (восходящий знак)": "опишите первое впечатление и внешний стиль только при точном времени рождения",
        "Личностные планеты (Меркурий, Венера, Марс)": "свяжите мышление, близость и действия с конкретными сильными навыками",
        "Социальные планеты (Юпитер, Сатурн)": "опишите стиль роста, ответственности и профессиональной реализации",
        "Высшие планеты (Уран, Нептун, Плутон)": "выделите необычный способ создавать новое, видеть системы или работать с образами",
        "Дома гороскопа (акцентные дома)": "выберите только дома с несколькими личными планетами или ключевыми связями",
        "Аспекты (ключевые соединения, квадраты, трины)": "возьмите наиболее точные и тематически важные аспекты",
    ...
    "money": {
        ...
        "Дом денег (2 дом)": "приоритет — 2 дом, его управитель и планеты в нём только при точном времени",
        "Дом работы и услуг (6 дом)": "приоритет — 6 дом и Меркурий как стиль ежедневной работы",
        "Дом инвестиций и партнёрских денег (8 дом)": "приоритет — 8 дом и аспекты к его показателям; без советов инвестировать",
        "Венера и Юпитер в карте": "опишите ценности, возможности роста и стиль создания дохода без гарантий",
        "Сатурн и Плутон в карте": "покажите дисциплину, границы и изменения отношения к деньгам без пугающих прогнозов",
        "Аспекты к денежным домам": "выберите самые точные связи с 2, 6 или 8 домом при точном времени",
        "Кармические долги в деньгах": "переведите наблюдения в осознанные привычки, не утверждайте прошлые жизни",
        "Периоды удачи": "не называйте даты и не обещайте доход; говорите о готовности к возможностям",
        "Лучшие профессии по карте": "предложите 2–4 конкретные роли или сферы, тип задач и рабочую среду без гарантии дохода",
